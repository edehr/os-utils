...
exports.useRound = (flag) => ROUND = flag
...
// Memory
exports.freemem = () => round(os.freemem() / (1024 * 1024))

exports.totalmem = () => round(os.totalmem() / (1024 * 1024))

exports.freememPercentage = () => round(os.freemem() / os.totalmem())
...
function getCPUUsage(free) {
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      ...
      resolve(round(free === true ? perc : 1 - perc))
    }, 1000)
  })
}
...
exports.getSummary = async () => ({
  ...
  cpuCount: exports.cpuCount(),
  sysUptime: exports.sysUptime(),
  processUptime: exports.processUptime(),
  freemem: exports.freemem(),
  totalmem: exports.totalmem(),
  freememPercentage: exports.freememPercentage(),
  loadavg: exports.loadavg(),
  loadavg1: exports.loadavg(1),
  loadavg5: exports.loadavg(5),
  loadavg15: exports.loadavg(15),
  cpuUsage: await exports.cpuUsage(),
  cpuFree: await exports.cpuFree(),
})
